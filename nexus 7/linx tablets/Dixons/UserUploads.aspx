<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="false" AutoEventWireup="True" CodeBehind="UserUploads.aspx.cs" Inherits="linx_tablets.Dixons.UserUploads" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:SqlDataSource ID="sqlDSPortal_Dixons_LastUpdates" runat="server" ConnectionString="<%$ ConnectionStrings:MSEConnectionString1 %>"
        SelectCommand="select * from vw_portal_dixons_useruploadslastupdates order by lastfiledate desc"></asp:SqlDataSource>
        ...
        <div class="row">
            <div class="col-lg-12 download-page">
                <div class="row">
                    ...
                    <asp:GridView ID="gvPortal_Dixons_LastUpdate" CssClass="CSSTableGenerator" runat="server" DataSourceID="sqlDSPortal_Dixons_LastUpdates" AutoGenerateColumns="false" OnRowDataBound="gvLastImportedForecastPortal_RowDataBound">
                        <Columns>
