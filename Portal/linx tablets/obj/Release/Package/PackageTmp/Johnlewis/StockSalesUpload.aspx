<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="false" AutoEventWireup="True" CodeBehind="StockSalesUpload.aspx.cs" Inherits="linx_tablets.Johnlewis.StockSalesUpload" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:SqlDataSource ID="sqldsuploads" runat="server" ConnectionString="<%$ ConnectionStrings:MSEConnectionString1 %>"
        SelectCommand="select * from MSE_PortalSalesEposFiles where customerid=6 and importdate>='18/10/2016'"></asp:SqlDataSource>

    <div class="container">
        <div class="row">
            <div class="col-lg-12 download-page">
                <div class="row">
                    <h1>JLP Stock/Sales Management</h1>
