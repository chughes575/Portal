<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="false" AutoEventWireup="True" CodeBehind="ProductForecasting.aspx.cs" Inherits="linx_tablets.Johnlewis.ProductForecasting" %>
        ...
        <div class="row">
            <div class="col-lg-12 download-page">
                ...
                <br />
                    ...
                    <br />
                    <asp:FileUpload ID="fupJlpForecast" runat="server" /><br />
                    <asp:Button ID="btnUploadJlpForecast" runat="server" Text="Upload" OnClick="btnUploadJlpForecast_Click" />

                    <h2>Jlp Product Stock Holding Rules</h2>
