        ...
        <div class="row">
            <div class="col-lg-12 download-page">
                <div class="row">
                    ...
                    <br />
                    <asp:ImageButton ID="excelConsolidatedImgIcon" runat="server" OnClick="excelConsolidatedImgIcon_Click" ImageUrl="~/Images/Excel-icon.png" Width="20px" /> Download Report (Breakdown by Exertis Code)
                    <br />
