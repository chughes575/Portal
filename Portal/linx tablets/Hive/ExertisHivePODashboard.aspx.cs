...
namespace linx_tablets.Hive
{
    public partial class ExertisStockPO : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvBundleSuggestions.DataSource = Common.runSQLDataset("exec [sp_portalhive_pobundlesuggestions_exertis_MFRPARTNO] 0");
        ...
        protected void excelImgIcon_Click(object sender, ImageClickEventArgs e)
        {
            ...
            runReport("exec [sp_portalhive_pobundlesuggestions_exertis_MFRPARTNO] 0", filename);
        }
        protected void excelConsolidatedImgIcon_Click(object sender, ImageClickEventArgs e)
        {
            ...
            runReport("[sp_portalhive_pobundlesuggestions_exertis_downloaddetail_backup]", filename);
