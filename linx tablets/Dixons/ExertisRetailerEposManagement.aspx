<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="false" AutoEventWireup="True" CodeBehind="ExertisRetailerEposManagement.aspx.cs" Inherits="linx_tablets.Dixons.EposSales" %>
        ...
        <div class="row">
            <div class="col-lg-12 download-page">
                <div class="row">
                   ...
                   Sales figures are at branch level-
                    The column eposdate represents the Monday of the weeks Sales
                    <h5>Table legend (Branch Type)</h5>
                    <table class="CSSTableGenerator">
                        <tr>
                            <td>DC</td>
                            <td style="padding-left:7px"> Sales Through DC</td>
                        </tr>
                        <tr>
                            <td>Store</td>
                            <td style="padding-left:7px"> Sales Through Stores</td>
                        </tr>
                        <tr>
                            <td>Travel</td>
                            <td style="padding-left:7px"> Sales Through Travel Stores</td>
                        </tr>
                        <tr>
                            <td>Other </td>
                            <td style="padding-left:7px"> Sales Through Unmapped Business Areas</td>
