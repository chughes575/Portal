...
namespace linx_tablets.Dixons
{
    public partial class ConsignmetnUploads : System.Web.UI.Page
    {
        ...
        protected void btnDownloadExistingConsignmentStock_Click(object sender, EventArgs e)
        {
            ...
            PortalCommon.Excel.GenerateExcelSheetNew(Common.runSQLDataset("exec sp_portal_generic_retailerconsignmentstock_existing " + customerID), "Inventory", filePath + filename);
