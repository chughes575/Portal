<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="True" CodeBehind="EmailReporting.aspx.cs" Inherits="linx_tablets.Dixons.EmailReporting" %>
