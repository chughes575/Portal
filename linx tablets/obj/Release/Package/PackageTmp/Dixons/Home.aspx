<%@ Page Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="false" AutoEventWireup="True" CodeBehind="Home.aspx.cs" Inherits="linx_tablets.Dixons.Home" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:SqlDataSource ID="sqlDSKewillProductStockStatusReport" runat="server" ConnectionString="<%$ ConnectionStrings:MSEConnectionString1 %>"
        SelectCommand="select * from vw_portal_dixons_homeview order by lastfiledate desc"></asp:SqlDataSource>
        ...
        <div class="row">
            <div class="col-lg-12 download-page">
                <div class="row">
                    ...
                    <asp:Panel ID="pnlStockSetup" runat="server" Visible="false">
