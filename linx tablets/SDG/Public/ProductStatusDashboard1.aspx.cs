...
{
    public partial class ProductStockStatusDashBoard : System.Web.UI.Page
    {
        ...
        protected string returnQuery()
        {
            ...
            baseQuery = "exec [sp_portal_Searchcustomerview1] ";
        ...
        protected void bindSearchResults()
        {
            ...
            ScriptManager.RegisterStartupScript(Page, this.GetType(), "Key", "<script>MakeStaticHeader('" + gvCustomerViewResults.ClientID + "', 600, 1200 , " + Common.getConfigValue("SDGNUM") + " ,false); </script>", false);
        }
